...
* **tflint:** 🐛 bump Azure rules version, fix signature bug 8ca7516

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 9121505
* **deps:** update dependency opentofu to v1.12.2 0583763
* **deps:** update dependency opentofu to v1.12.3 9939c75
* **deps:** update dependency opentofu to v1.12.4 17ada9e
* **deps:** update dependency tflint to v0.63.1 52e462c
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 5816a98
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 a4c6f60

## 8.1.4 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 04ad350

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu 754df31
* **deps:** update dependency opentofu to v1.11.7 5ca0261
* **deps:** update dependency opentofu to v1.12.0 d422ab4
* **deps:** update dependency terraform-docs to v0.23.0 bf51ae6
* **deps:** update dependency terraform-docs to v0.24.0 5329c6b
* **deps:** update dependency tflint to v0.62.1 1b9c4d9
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 48dfa4c
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 0e2a626
* **pre-commit:** 🔧 move to prek c07eaa4
* **tfdocs:** bump tfdocs to v0.22 🔧 baec198
...
* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 b41cb7e

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.11.2 0c31b37
* **deps:** update dependency opentofu to v1.11.3 728e0c0
* **deps:** update dependency opentofu to v1.11.4 9b65d23
* **deps:** update dependency opentofu to v1.11.5 3243a41
* **deps:** update dependency pre-commit to v4.5.1 e53af37
* **deps:** update dependency terraform-docs to v0.21.0 fd90988
* **deps:** update dependency tflint to v0.61.0 c5f6a6f
* **deps:** update dependency trivy to v0.68.2 b2a05b5
* **deps:** update dependency trivy to v0.69.0 4cf3607
* **deps:** update dependency trivy to v0.69.1 02560ce
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 b28800a
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 666c300
